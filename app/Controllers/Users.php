...
class Users extends Controller {
    ...
    public function create(){
        ...
        $this->session->setFlashdata('message', "<div class = 'alert alert-success'><b> Usuário adicionado com sucesso!</b></div>");
    ...
    public function delete($id = NULL){
        ...
        /* add success message in flashdata */
        $this->session->setFlashdata('message', "<div class = 'alert alert-success'><b>Deletado com sucesso!</b></div>");
